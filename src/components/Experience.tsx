...
const experiences = [
  {
    ...
    description: 'Completed a AI internship through the TechSaksham initiative by Microsoft and SAP. Built a strong foundation in machine learning, natural language processing (NLP), and ethical AI. Gained hands-on experience with tools like Python, Jupyter Notebooks, and TensorFlow while working on real-world projects focused on problem-solving, data analysis, and model development. Participated in expert-led sessions and mentorship by Microsoft and SAP professionals to understand industry standards and AI’s practical impact. Collaborated with peers on innovation-driven activities, enhancing critical thinking, teamwork, and applied AI skills.',
